...
const About: React.FC = () => {
  const stats = [
    { icon: Users, value: "1500+", label: "LinkedIn Followers", delay: 0 },
    { icon: Award, value: "50+", label: "Active Projects", delay: 0.1 },
    { icon: Clock, value: "5+", label: "Years Experience", delay: 0.2 },
