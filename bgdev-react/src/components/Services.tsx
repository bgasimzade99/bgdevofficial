      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            Enterprise-Grade
            <br />
            <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent">Technology Expertise</span>
          </motion.h2>
          ...
          >
            From edge-ready Next.js apps to resilient data layers with PostgreSQL, MongoDB,
            and Prisma—we design and ship production-grade systems with observability, security,
            and performance in mind.
          </motion.p>

          <motion.div
            variants={itemVariants}
            className="mt-12 max-w-5xl mx-auto px-2 sm:px-0"
          >
            <div className="flex items-center justify-center gap-2 text-blue-300/90 mb-5">
              <Layers className="w-4 h-4" aria-hidden />
              <span className="text-xs sm:text-sm font-semibold uppercase tracking-[0.2em]">
                Modern stack & tooling
              </span>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md px-4 py-6 sm:px-6 sm:py-7">
              <div className="flex flex-wrap justify-center gap-2 sm:gap-2.5">
                {techStack.map((name, i) => (
                  <motion.span
                    ...
                    className="px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium text-gray-100 bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/10 shadow-sm hover:border-blue-400/40 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] transition-all duration-300"
                  >
                    {name}
                  </motion.span>
                ))}
